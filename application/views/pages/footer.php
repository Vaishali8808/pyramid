      ...
      <div class="row">
        ...
        <div class="col-12 col-md">
          ...
          <address>
            ...
            Ambala, Haryana, India.<br />
              <i class="fa fa-phone"> </i>+91-9354363673<br />
              <i class="fa fa-envelope"> </i>info@pyramidinfotech.com 
          </address>
          <div class="btn-group text-center" role="group">
            <a class="btn btn-primary" href="tel:+919354363673">
        ...
        <div class="col col-md align-self-center pt-5" id="social_button">
          <div class="text-center">
            <a class="btn btn-social-icon btn-facebook" href="wwww.facebook.com"><i class="fab fa-facebook-f"></i></a>
