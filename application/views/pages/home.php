...
<div id="top_carousel" class="carousel slide m-top  " data-ride="carousel">
  ...
  <br>
  <div class="text-center my-2"><h2 class="text-muted">Our Services</h2> </div>
  <div class="container">
    <div class="row justify-content-around content-row">
      <div class="col-lg-4 col-sm-6 bg-light p-3">
        <div style="color: #B05DB1;" class="text-center">
          <i class="fas fa-magic fa-7x"></i>
        </div>
        <div class="text-center my-5">
          <h4 class="text-muted">Front-End Development</h4>
          <p class="">Design, Development, Marketing.
              Front-end web development is the practice of converting data to graphical interface 
              for user to view and interact with data through digital interaction using latest Web Technologies.
        </div>
      </div>
      <div class="col-lg-4 col-sm-6 bg-light  p-3">
        <div style="color:#B05DB1;" class="text-center">
        ...
        <div class="text-center my-5">
          <h4 class="text-muted">Back-End Development</h4>
          <p class="">Backend development handle the 'behind-the-scenes' functionality of web applications. It's code that 
      ...
      <div class="col-lg-4 col-sm-6 bg-light p-3">
        ...
        <div class="text-center my-5">
          <h4 class="text-muted">Testing</h4>
          <p class="">Start off on the right foot.
              Complete testing of a web-based system before going live can help address issues before the system is revealed to the public!</p>
    </p>
        </div>
      </div>
    </div>
    ...
    <div class="row content-row featurette ">
      <div class="col-md-7">
        ...
        <p class="lead">In the digital age, it is absolutely essential for your business to have an online presence. Whether it’s a website, an e-commerce platform, 
    ...
    <div class="row featurette">
      <div class="col-md-7 order-md-2">
        <h2 class="featurette-heading">Content builds relationships. Relationship are built on trust. 
           <span class="text-muted">Trust drives revenue..</span></h2>
        <p class="lead">A successful Application does three things:
            <ul>
              <li>It attracts the right kinds of visitors.</li>
              <li>Guides them to the main services or product you offer.</li>
              <li>Collect Contact details for future ongoing relation.</li>
            </ul>
  </p>
      </div>
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading">One small thing left…
          <span class="text-muted">A smart and beautiful design.</span></h2>
        <p class="lead">Design is intelligence made visible.. Have an idea for web application? 
          Does your company or product need 
          a responsive website? Do you need a backend with API? Or do you need a help with web 
